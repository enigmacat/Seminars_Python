...
# Условие: На столе лежит 2021 конфета. Играют два игрока делая ход друг после друга.
...
def player_vs_player():
    ...
    print(f'\nНу чтож {player_1} и  {player_2} начнём!\n')
    print('\nСначала опеределим кто первый начнет игру.\n')
